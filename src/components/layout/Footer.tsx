    ...
    <footer className='mt-4 pb-2'>
      <main className='layout flex flex-col items-center border-t pt-6 dark:border-gray-600'>
        ...
        <p className='mt-8 text-sm text-gray-600 dark:text-gray-300'>
          © Mohammed Yassar {new Date().getFullYear()}
          {feedbackFlag && (
            <>
              {' • '}
              <FeedbackFish
    ...
    <div className='mt-2 flex space-x-4'>
      <div className='flex items-center justify-center'>
        ...
        >
          <button
            onClick={() => {
              copy('yaserkt786@gmail.com').then(() => {
...
const footerLinks: { href: string; text: string; tooltip: React.ReactNode }[] =
  [
    ...
    },
    {
      href: '/design',
      text: 'Design',
      tooltip: 'color palette of this Portfolio',
    },
    // {
...
const socials: Social[] = [
  ...
  {
    href: 'https://www.linkedin.com/in/mohammed-yassar-275660209/',
    icon: SiLinkedin,
    id: 'Linkedin',
    text: (
      <>
